...
| <div align="center"><strong>Fix</strong><br><img src="./fix/assets/icon.png" width="40" alt="Fix crossed wrenches icon"></div> | Investigate technical failures before applying narrow, verified fixes. | `npx skills@latest add CratesSo/skills/fix` | <div align="center">no</div> |
