...
<img src="./plan-my-grill/assets/icon.png" width="40" alt="Plan My Grill icon"> !! WARNING: This is a good skill !!
...
<img src="./agents-splitter/assets/icon.png" width="40" alt="Agents Splitter icon"> Split large AGENTS.md guidance into on-demand reference files.
...
<img src="./lessons-doctor/assets/icon.png" width="40" alt="Lessons Doctor icon"> Move durable repo lessons into local AGENTS.md guidance.
...
<img src="./report/assets/icon.png" width="40" alt="Report icon"> Generate complete standalone HTML reports from recap or custom requests.
